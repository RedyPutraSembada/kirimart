...
import { useGetSellerVouchers } from "@/app/data/seller-dashboard/voucher/voucher-data"
import { deleteVoucher } from "@/actions/seller-dashboard/voucher/voucher.actions"
...
export function VoucherList() {
	...
	const { data: vouchersData, isLoading, error } = useGetSellerVouchers(
	...
	return (
		<div className="space-y-6">
			<div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
				...
				<Button asChild>
					<Link href="/seller-dashboard/vouchers/create">
												...
												<TableCell className="text-center">
													<DropdownMenu>
														...
														<DropdownMenuContent align="end">
															...
															<DropdownMenuItem>
																<Button variant="ghost" onClick={() => router.push(`/seller-dashboard/vouchers/${v.id}/edit`)}>
