...
import { createVoucher } from "@/actions/seller-dashboard/voucher/voucher.actions"
...
export function FormCreateVoucher() {
	...
	const createMutation = useMutation({
		...
		onSuccess: () => {
			...
			router.push("/seller-dashboard/vouchers")
		},
		onError: (error) => {
		...
		<div className="space-y-6">
			...
			<div className="flex items-center gap-4">
				<Button variant="outline" size="icon" asChild>
					<Link href="/seller-dashboard/vouchers">
						<ArrowLeft className="h-4 w-4" />
					</Link>
				</Button>
				<div>
					<h1 className="text-2xl font-bold tracking-tight">Buat Voucher Baru</h1>
					<p className="text-muted-foreground">Buat kode promo untuk menarik pembeli.</p>
				</div>
			</div>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormDescription>Kode unik yang dimasukkan pembeli saat checkout.</FormDescription>
													<FormMessage />
												</FormItem>
											)}
										/>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormDescription>Batas atas potongan untuk tipe persentase. Kosongkan jika tidak ada batasan.</FormDescription>
													<FormMessage />
												</FormItem>
											)}
										/>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<FormDescription>Minimum total belanja agar voucher bisa digunakan.</FormDescription>
												<FormMessage />
											</FormItem>
										)}
									/>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<FormDescription>Berapa kali voucher ini bisa digunakan secara total.</FormDescription>
												<FormMessage />
											</FormItem>
										)}
									/>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<FormDescription>Format: JPG, PNG. Maks {MAX_FILE_SIZE_MB || 1} MB. Untuk banner promosi voucher.</FormDescription>
												<FormMessage />
											</FormItem>
										)}
									/>
								...
								<CardContent className="space-y-3 text-sm">
									...
									<Button type="submit" className="w-full" disabled={isPending}>
										{isPending ? (
											...
											<><Save className="mr-2 h-4 w-4" />Simpan Voucher</>
										)}
									</Button>
								</CardContent>
							</Card>
							...
							<Card className="bg-blue-50/50 border-blue-200 dark:bg-blue-950/30 dark:border-blue-800">
								<CardContent className="pt-6">
									<p className="text-sm text-blue-800 dark:text-blue-300">
										💡 <strong>Tips:</strong> Voucher dengan minimum belanja rendah dan diskon menarik cenderung lebih cepat digunakan pembeli!
									</p>
								</CardContent>
							</Card>
						</div>
