...
import { createAdminVoucher } from "@/actions/admin-dashboard/voucher/voucher.actions"
		...
		<div className="space-y-6">
			...
			<div className="flex items-center gap-4">
				...
				<div>
					...
					<p className="text-muted-foreground">Buat kode promo global untuk seluruh platform.</p>
				</div>
			</div>
