...
export default function SignUpPage() {
	...
	async function onSubmit(data) {
		...
		await authClient.signUp.email(
			...
			{
				onSuccess: async () => {
					// Paksa sign-out agar user tidak auto-login setelah daftar
				...
				onError: (ctx) => {
					...
					const msg = ctx.error.message === 'User already exists' 
				...
				<div className='flex flex-col items-center gap-3 text-center'>
					...
					<div className="space-y-1">
						...
						<p className='text-sm text-muted-foreground'>
							Bergabung dan mulai belanja di kawanbelanja
						</p>
					</div>
				</div>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input placeholder='Contoh: Budi Santoso' className="h-10 rounded-xl text-sm" {...field} />
										</FormControl>
